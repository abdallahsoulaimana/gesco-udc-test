...
<div class="container-xl">
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
            <h1 class="app-page-title mb-0">Mes Voitures</h1>
        </div>
        <div class="col-auto">
        ...
        <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
            <div class="app-card app-card-doc shadow-sm  h-100">
                ...
                <div class="app-card-body p-3 has-card-actions">
                    ...
                    <h4 class="app-doc-title truncate mb-0"><a href="#file-link"> {{ $voiture->name; }} </a></h4>
                    <div class="app-doc-meta">
                        <ul class="list-unstyled mb-0">
                            <li><span class="text-muted">Marque:</span> {{ $voiture->marque; }}</li>
                            <li><span class="text-muted">Couleur:</span> {{ $voiture->color; }}</li>
                            <li><span class="text-muted">Matricule:</span> {{ $voiture->imatriculation; }}</li>
                        </ul>
                    </div><!--//app-doc-meta-->
